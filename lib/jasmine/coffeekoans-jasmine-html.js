...
CoffeeKoansReporter.prototype.createDom = function(type, attrs, childrenVarArgs) {
...
CoffeeKoansReporter.prototype.reportSpecStarting = function(spec) {
};
...
CoffeeKoansReporter.prototype.log = function() {
  var console = jasmine.getGlobal().console;
  if (console && console.log) console.log.apply(console, arguments);
};

CoffeeKoansReporter.prototype.getLocation = function() {
  return this.document.location;
};

CoffeeKoansReporter.prototype.specFilter = function(spec) {
  var paramMap = {};
...
CoffeeKoansReporter.prototype.getSuiteDescription = function(suite) {
